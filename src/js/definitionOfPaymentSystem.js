export default function definitionOfPaymentSystem(cardNumber) {
  ...
  const mirRegexp = '/^220[0-4][0-9]{12,15}$/';

  const visaRegexp = '/^4[0-9]{12}(?:[0-9]{0}|[0-9]{3}|[0-9]{6})$/';
  const mastercardRegexp = '/^5[1-5][0-9]{14}|222[1-9][0-9]{12}|22[3-9][0-9]{13}|2[3-6][0-9]{14}|27[01][0-9]{13}|2720[0-9]{12}$/';

  const americanExpressRegexp = '/^3[47][0-9]{13}$/';
  const discoverRegexp = '/^6(?:011|5[0-9]{2})(?:[0-9]{12}|[0-9]{15})$/';

  const jcbRegexp = '/^(?:2131|1800|35[0-9]{2})[0-9]{12,15}$/';
